...
const products: Product[] = [
  ...
  {
    model: "DL/T698 · MODBUS",
    name: "光伏通信协议转换器",
    image: asset("images/iot-pv.png"),
    category: "iot",
    desc: "应用于光伏新能源接入系统，安装在分布式能源逆变器侧，自动采集光伏逆变器发电用电数据，监测计量异常与电能质量，支持市场主流光伏逆变器厂家协议。",
    specs: [
    ...
    tags: ["分布式光伏", "柔性调控", "蓝牙维护"],
    status: "量产",
    highlights: [
      "抄读逆变器电压、电流、功率，监测逆变器状态",
      "柔性调控：功率输出、功率因数调节、开关机操作",
      "支持逆变器数据透传采集",
      "485 + RJ45 + 载波双模 + 蓝牙多种通信方式",
    ],
    tables: [
      {
        title: "基本型 / 增强型对比",
        columns: ["版本", "测量准确度", "特色功能", "通信与接口"],
        rows: [
          ["基本型", "电压 1.0 级", "柔性调控、多种事件记录上报", "2 路上行 485、2 路 RJ45、载波双模、蓝牙"],
          ["增强型", "电压 0.5 级，谐波 1 级", "孤岛监测、电能质量监测、本地/远程控制", "2 路上行 485、4 路 RJ45、载波双模、12V 输出、控制电平、蓝牙"],
        ],
      },
    ],
  },
  {
    model: "0.5 级计量",
    name: "智能量测开关",
    image: asset("images/iot-metering.png"),
    category: "iot",
    desc: "集通信、计量、保护、控制和边缘计算于一体的数字型塑壳断路器，广泛应用于电网配电台区数字化建设，以及建筑、园区、工厂、医院等用户侧配电设施与能耗监测场景。",
    specs: [
      { label: "电压/电流精度", value: "0.5 级（分相）" },
      { label: "量测单元", value: "可热插拔" },
      { label: "通信", value: "HPLC / RS485 / 蓝牙" },
      { label: "拓扑识别", value: "特征电流动态识别" },
    ],
    tags: ["过载短路保护", "温度采集", "边缘计算"],
    status: "量产",
    highlights: [
      "线路正常接通、分断及过载、短路保护",
      "测量总及分相有功/无功功率、功率因数、频率、电能量",
      "配合温度传感器实现各相进出线温度采集",
      "HPLC 通信及特征电流收发，实现动态拓扑识别",
    ],
  },
  {
    model: "三段保护 · 孤岛保护",
    name: "物联网塑壳断路器（光伏开关）",
    image: asset("images/iot-breaker.png"),
    category: "iot",
    desc: "具备长延时、短路短延时、瞬时、过欠压及断相保护功能与孤岛保护（光伏），采集精度达计量级，支持电力线载波通讯与台区拓扑识别，为能效管理、故障查找及线损分析提供数据。",
    specs: [
      { label: "保护功能", value: "三段电流 + 过欠压 + 断相" },
      { label: "采集精度", value: "计量级" },
      { label: "通信方式", value: "RS485 / 宽带载波 / 微功率无线" },
      { label: "规约", value: "DL/T645" },
    ],
    tags: ["孤岛保护", "拓扑识别", "温湿度监测"],
    status: "量产",
    highlights: [
      "开关位置、电流、电压、功率、电量等信息采集上报",
      "台区拓扑自动识别，户变/相序/分支信息采集",
      "本地显示运行信息与故障记录，远程定值设置",
      "上电自检自恢复，故障告警及上报",
    ],
  },
  {
  ...
  },
  {
    ...
    category: "iot",
    desc: "集成北斗三号定位授时模组、4G/485 通信与太阳能供电管理的系列终端，支持 BDS3、GPS、GLONASS、Galileo 多系统联合定位，覆盖定位授时、杆塔故障定位与塔杆倾斜监测场景。",
    specs: [
      { label: "卫星系统", value: "BDS3 / GPS / GLONASS / Galileo" },
      { label: "通信", value: "4G Cat.1 / RS485 / 蓝牙" },
      { label: "供电", value: "太阳能 + 宽温电池" },
      { label: "防护等级", value: "IP65 / IP67" },
    ],
    tags: ["厘米级定位", "远程 OTA", "电力内网加密"],
    status: "量产",
    tables: [
      {
        title: "北斗终端系列选型",
        columns: ["终端类型", "核心能力", "精度指标", "供电 / 防护", "应用场景"],
        rows: [
          ["定位授时终端", "多系统联合定位授时", "1PPS 优于 100ms，水平优于 3m", "功耗 ≤0.3W，IP65", "金融 / 通信 / 电力 / 交通授时"],
          ["配电杆塔故障定位终端", "RTK 定位 + 倾斜监测", "RTK 水平优于 10cm，倾斜 ±1°", "太阳能 + 1300mAh 宽温锂电，IP67", "配电杆塔 / 信号塔"],
          ["塔杆倾斜检测终端", "高精度倾斜监测", "范围 ±15°，精度 ±0.05°", "太阳能 + 钛酸锂电池，IP65", "高压铁塔 / 建筑主体 / 工程机械"],
        ],
      },
    ],
  },
